                ...
                <ul id="route">
                    ...
                    <li>
                        ...
                        <div class="text1">
                            <p>工软文创系列：奋斗吧青春帆布包</p>
                            <br/>
                            <p>工行软件开发中心定制帆布包，百搭又实用，将企业的文化凝聚成口号印在帆布包上，具有很好的纪念意义。</p>
                        </div>
                        <div class="price">
                            <p class="price_num">
                                <span>&yen;</span>
                            ...
                            <p><a href="javascript:void(0);" onclick="showInfo(2)">查看详情</a></p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="price">
                            ...
                            <p><a href="javascript:void(0);" onclick="showInfo(3)">查看详情</a></p>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="price">
                            ...
                            <p><a href="javascript:void(0);" onclick="showInfo(4)">查看详情</a></p>
                        </div>
                    </li>
                    <!--<li>
